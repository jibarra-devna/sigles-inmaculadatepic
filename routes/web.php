...
Route::get('/librosparroquiales/agregarprimeracomunion', [AgregarPrimeraComunionController::class, 'index'])->name('primeracomunion');
Route::get('/librosparroquiales/agregarconfirmacion', [AgregarConfirmacionController::class, 'index'])->name('confirmaciones');
Route::get('/librosparroquiales/agregarmatrimonio', [AgregarMatrimonioController::class, 'index'])->name('matrimonios');
