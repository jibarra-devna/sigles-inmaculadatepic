    ...
    <div class="card mb-4">
      <div class="card-body">
        <form>
          <div class="mb-3">
            <p></p>
            <h5><b>Datos del Bautismo</b></h5> <!--<small class="text-muted float-end">Default label</small>-->
          </div>
        ...
        <br>
        <h5><b>Datos del Registro Civil</b></h5>
        <div style="display:grid;grid-template-columns: 1fr 1fr;grid-gap:1.25rem">
          <div>
