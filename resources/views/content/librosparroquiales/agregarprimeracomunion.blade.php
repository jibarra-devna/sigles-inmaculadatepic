...
@section('title', 'Agregar Primera Comunión')

@section('content')
<div style="display:grid;grid-template-columns: 1fr 1fr;grid-gap:1.25rem">
    <h6><span class="text-muted fw-light"><a href="\laravel\siglesia-inmaculadatepic\public\inicio">Libros Parroquiales</a> / <a href="\laravel\siglesia-inmaculadatepic\public\librosparroquiales\primeracomunion">Primera Comunión</a> / </span> Agregar Primera Comunión</h6>
      ...
      <div class="card-body">
        ...
        <div style="display:grid;grid-template-columns: 1fr 1fr;grid-gap:1.25rem">
          ...
          <div>
            ...
            <input type="date" class="form-control" name="pc-ba-fecha" id="nombre"/>
          </div>
          <div>
            <label class="form-label">Población Parroquia</label>
            <input type="text" class="form-control" name="pc-ba-poblacion-parroquia" id="pc-ba-poblacion-parroquia"/>
          </div>
          <div>
            <label class="form-label">Estado Parroquia</label>
            <select type="text" class="form-control" name="pc-ba-estado-parroquia" id="pc-ba-estado-parroquia"/>
              <option value="">Seleccione uno ↓</option>
        ...
        <div style="display:grid;grid-template-columns: 1fr 1fr;grid-gap:1.25rem">
          <div>
            ...
            <input type="text" class="form-control" name="pc-pad-padre" id="pc-pad-padre"/>
          </div>
          <div>
            <label class="form-label">Nombre Madre</label>
            <input type="text" class="form-control" name="pc-pad-madre" id="pc-pad-madre"/>
          </div>
        </div>
        <br>
        ...
        <div style="display:grid;grid-template-columns: 1fr 1fr;grid-gap:1.25rem">
          <div>
            ...
            <input type="text" class="form-control" name="pc-pad-padrino" id="pc-pad-padrino"/>
          </div>
          <div>
            <label class="form-label">Nombre Madrina</label>
            <input type="text" class="form-control" name="pc-pad-madrina" id="pc-pad-madrina"/>
          </div>
        </div>
        <br>
