...
@section('title', 'Primera Comunión')

@section('content')

  <div style="display:grid;grid-template-columns: 1fr 1fr;grid-gap:1.25rem">
    <h6><span class="text-muted fw-light"><a href="\laravel\siglesia-inmaculadatepic\public\inicio">Libros Parroquiales</a> / </span> Primera Comunión</h6>
...
<div class="card">
  <h5 class="card-header">Table Basicaa</h5>
