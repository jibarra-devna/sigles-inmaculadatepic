  ...
  <div class="col-lg-8 mb-4 order-0">
    <div class="card">
      <div class="d-flex align-items-end row">
        <div class="col-sm-7">
          <div class="card-body">
            <h5 class="card-title text-primary">YA PUDE WE</h5>
          ...
          <div class="card-body">
            <div class="card-title d-flex align-items-start justify-content-between">
              <div class="avatar flex-shrink-0">
                <img src="{{asset('assets/img/icons/unicons/bautismo-icon.png')}}" alt="chart success" class="rounded">
              </div>
              <div class="dropdown">
            ...
            <span class="fw-semibold d-block mb-1">Bautismos</span>
      ...
      <div class="col-lg-6 col-md-12 col-6 mb-4">
        <div class="card">
          <div class="card-body">
            <div class="card-title d-flex align-items-start justify-content-between">
              <div class="avatar flex-shrink-0">
                <img src="{{asset('assets/img/icons/unicons/pcomunion-icon.png')}}" alt="Credit Card" class="rounded">
              </div>
              <div class="dropdown">
      ...
      <div class="col-6 mb-4">
        <div class="card">
          <div class="card-body">
            <div class="card-title d-flex align-items-start justify-content-between">
              <div class="avatar flex-shrink-0">
                <img src="{{asset('assets/img/icons/unicons/confirmacion-icon.png')}}" alt="Credit Card" class="rounded">
              </div>
              <div class="dropdown">
            ...
            <span class="d-block mb-1">Confirmaciones</span>
      ...
      <div class="col-6 mb-4">
        <div class="card">
          <div class="card-body">
            <div class="card-title d-flex align-items-start justify-content-between">
              <div class="avatar flex-shrink-0">
                <img src="{{asset('assets/img/icons/unicons/matrimonio-icon.png')}}" alt="Credit Card" class="rounded">
              </div>
              <div class="dropdown">
            ...
            <span class="fw-semibold d-block mb-1">Matrimonios</span>
